...
export default function ViewHighlights(){
    ...
    return(
        ...
        <div className='Vid-container'>
            <iframe src={`https://player.twitch.tv/?video=${vodId}&time=${timeStamp}&parent=vodclipper.me&parent=www.vodclipper.me`} muted ="false" frameborder="0" allowfullscreen="true" scrolling="no"  preload="auto"></iframe> 
        </div>
